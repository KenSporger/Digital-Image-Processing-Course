...
int yoloV3()
{
	...
	//coco数据集的名称文件，可识别其中列出的80类物体
	string classesFile= "../network/coco.names";
	//yolov3网络模型文件
	String yolov3_model = "../network/yolov3.cfg";
	//权重
	String weights = "../network/yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "../network/openpose_pose_coco.prototxt";
	...
	case 0:
		//coco
		modelBin = "../network/caffe_models/pose/coco/pose_iter_440000.caffemodel";
		break;
	case 1:
		//body25
		modelBin = "../network/caffe_models/pose/body_25/pose_iter_584000.caffemodel";
		break;
	case 2:
		//mpi
		modelBin = "../network/caffe_models/pose/mpi/pose_iter_160000.caffemodel";
		break;
	default:
		//coco
		modelBin = "../network/caffe_models/pose/coco/pose_iter_440000.caffemodel";
...
int openFace()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "../network/pose_deploy.prototxt";

	//caffe pose下有三种输出模式
	String modelBin = "../network/caffe_models/face/pose_iter_116000.caffemodel";
